...
A premium, polished AI chat interface that routes seamlessly between local Ollama models and cloud APIs (OpenAI, Anthropic, Gemini..) via a unified gateway. Runs entirely via Docker or Podman.
